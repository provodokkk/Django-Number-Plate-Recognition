...
from paths import RESULTS_CSV_FILE_PATH, INTERPOLATED_CSV_FILE_PATH
...
# Load the CSV file
with open(RESULTS_CSV_FILE_PATH, 'r') as file:
...
with open(INTERPOLATED_CSV_FILE_PATH, 'w', newline='') as file:
